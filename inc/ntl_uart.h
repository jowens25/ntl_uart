...
typedef struct PtpOc
{
	...
	// uint8_t CurrentDsStepsRemoved;
	// uint8_t CurrentDsOffset;
	...
	// uint8_t TimePropertiesDsUtcOffset;
	// uint8_t TimePropertiesDsCurrentOffset;
	// uint8_t TimePropertiesDsJumpSeconds;
	// uint8_t TimePropertiesDsNextJump;
	// uint8_t TimePropertiesDsDisplayName;
